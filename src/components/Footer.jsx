...
export default function Footer() {
  return (
    <footer className="bg-navy-900 border-t border-primary-container w-full" role="contentinfo">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 px-4 md:px-16 py-12 max-w-[1280px] mx-auto">
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="font-label-sm text-label-sm text-gray-500">
            © {COMPANY.established}-{new Date().getFullYear()} {COMPANY.name}. Proprietorship. Part of {COMPANY.parentGroup}. MEA Approved.
          </div>
        </div>
        ...
        <nav aria-label="Legal">
          ...
          <div className="flex gap-2 mt-5">
            ...
            <a href={`tel:${COMPANY.offices.india.phone}`} aria-label="Call us" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-gray-400 hover:bg-emerald-500 hover:text-white transition-all">
